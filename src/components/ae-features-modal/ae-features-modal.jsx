...
const mainMessages = defineMessages({
    ...
    introduction: {
        defaultMessage:
            "We made more features to make your coding speed lighting fast.",
    ...
    InitializationMessage: {
        defaultMessage:
            "You need some settings to be initialized before using AstraEditor.",
    ...
    InitializationStart: {
        ...
        description:
            "Initialization Start Message in button of the ae-features modal",
...
const AeFeaturesComponent = (props) => {
    ...
    return (
        <Modal
            ...
            onRequestClose={() => {
                if (!localStorage.getItem("ae:firstEnter")) {
            ...
            <Box className={styles.body}>
                    ...
                    <>
                        ...
                        >
                            ...
                            <p>
                                <FormattedMessage
                                    defaultMessage={
                                        '2. Type "#README" at the beginning, then write the project\'s README in Markdown format after that.'
                                    }
                            ...
                            <br />
                            <a
                                href="https://editors.astras.top/document/features/readme/"
                                target="_blank"
                                rel="noreferrer"
                            >
                ...
                {nowPage === "main" && (
                    <>
                        ...
                        {isUpdated() && (
                            <button
                                className={styles.linkDivContent}
                                onClick={() =>
                                    window.open(
                                        "https://github.com/AstraEditor/Desktop/releases",
                                        "_blank",
                                    )
                                }
                            >
                        ...
                        {localStorage.getItem("ae:webBuild") !==
                            version.webBuild && (
                            <>
                                <h3>
                                    <FormattedMessage
                        ...
                        {!localStorage.getItem("ae:firstEnter") && (
                            <>
                                <h4>
                                    <FormattedMessage
                                        {...mainMessages.InitializationMessage}
                                    />
                                </h4>
                                <button
                                    className={styles.linkDivContent}
                                ...
                                >
                                    <FormattedMessage
                                        {...mainMessages.InitializationStart}
                                    />
                                </button>
                            </>
                        )}
                                    ...
                                    onClick={() =>
                                        alert(
                                            props.intl.formatMessage(
                                                mainMessages.StayTuned,
                                            ),
                                        )
                                    }
                                >
                                    <FormattedMessage
                                        {...mainMessages.MoreOptimizes}
                                    />
                                </div>
                                <div
                                    className={styles.linkDivContent}
