const ADD_TAB = 'scratch-gui/monaco-editor-tabs/ADD_TAB';
const REMOVE_TAB = 'scratch-gui/monaco-editor-tabs/REMOVE_TAB';
const ACTIVATE_TAB = 'scratch-gui/monaco-editor-tabs/ACTIVATE_TAB';
const UPDATE_TAB_CODE = 'scratch-gui/monaco-editor-tabs/UPDATE_TAB_CODE';
const UPDATE_TAB_NAME = 'scratch-gui/monaco-editor-tabs/UPDATE_TAB_NAME';
const SET_TAB_SAVED = 'scratch-gui/monaco-editor-tabs/SET_TAB_SAVED';
...
export {
    reducer as default,
    initialState as monacoEditorTabsInitialState,
    addTab,
    removeTab,
    activateTab,
    updateTabCode,
